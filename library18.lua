...
local Themes = {
    ...
    Quantum = {
        ...
        AcrylicBorder = Color3.fromRGB(0, 132, 255),
        AcrylicGradient = ColorSequence.new(Color3.fromRGB(20, 20, 20), Color3.fromRGB(20, 20, 20)),
    
        TitleBarLine = Color3.fromRGB(0, 132, 255),
        Tab = Color3.fromRGB(0, 132, 255),
        ...
        ToggleSlider = Color3.fromRGB(11, 102, 186),
        ToggleToggled = Color3.fromRGB(255, 255, 255),
    
        SliderRail = Color3.fromRGB(0, 132, 255),
